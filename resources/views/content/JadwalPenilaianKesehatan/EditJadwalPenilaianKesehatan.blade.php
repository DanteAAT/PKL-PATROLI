...
@endif
    ...
    <form action="{{ url('/jadwal-penilaian-kesehatan/edit/process/' . $JadwalPenilaianKesehatan['penilaian_kesehatan_schedule_id']) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
