...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Detail Perlengkapan</li>
        </ol>
    </nav>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="equipment_name" id="equipment_name"
                                value="{{ $Equipment['equipment_name'] }}" readonly />
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="number" name="equipment_amount"
                                id="equipment_amount" value="{{ $Equipment['equipment_amount'] }}" readonly />
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            @if ($Equipment['quality'] == 1)
                                <input class="form-control input-bb" type="text" name="quality" id="quality"
                                    value="Bagus" readonly />
                            @elseif ($Equipment['quality'] == 2)
                                <input class="form-control input-bb" type="text" name="quality" id="quality"
                                    value="Sedang" readonly />
                            @elseif ($Equipment['quality'] == 3)
                                <input class="form-control input-bb" type="text" name="quality" id="quality"
                                    value="Rusak" readonly />
                            @endif
                            @error('quality')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea rows="2" cols="" rows="" class="form-control input-bb" name="equipment_information"
                                id="equipment_information" readonly>{{ $Equipment['equipment_information'] }}</textarea>
