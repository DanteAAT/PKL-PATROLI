...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Penilaian Kesehatan</li>
    </ol>
  </nav>
...
<div class="card border border-dark">
    ...
    <form method="" action="/penilaian-kesehatan/tambah/process" enctype="multipart/form-data">
        @csrf
        @php
        $bulan = [
            '01' => 'Januari',
            ...
            <div class="row form-group">
                <div class="col-md-3">
                    <div class="form-group">
                        <a class="text-dark">Personil<a class='red'> *</a></a>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <a class="text-dark">Jadwal Penilaian Kesehatan</a>
                        <select class="selection-search-clear" name="penilaian_kesehatan_schedule_id" id=""
                                style="width: 100% !important">
                                <option value="" selected hidden></option>
                                @foreach ($penilaian_kesehatan_schedule as $pks)
                                    <option value="{{ $pks['penilaian_kesehatan_schedule_id'] }}">{{ $bulan[$pks['period_month']]  }} {{ $pks['period_year'] }}</option>
                                @endforeach
                            </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="selection-search-clear" name="penilaian_kesehatan_category_id" id=""
                                ...
                                @foreach ($penilaian_kesehatan_category as $pkc)
                                    <option value="{{ $pkc['penilaian_kesehatan_category_id'] }}">{{ $pkc['penilaian_kesehatan_category_name'] }}</option>
                                @endforeach
                            </select>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="value" id="" value=""/>
                    </div>
                </div>
            </div>
        </div>
